...
public class WidgetPerfLinter {
  ...
  static List<PerfTipRule> getAllTips() {
    ...
    tips.add(new PerfTipRule(
      ...
      "listViewLoad",
      "https://docs.flutter.io/flutter/widgets/ListView-class.html#child-elements-lifecycle",
    ...
    tips.add(new PerfTipRule(
      ...
      "opacityAnimations",
      "https://docs.flutter.io/flutter/widgets/Opacity-class.html#performance-considerations-for-opacity-animation",
      matchParent("Opacity"),
      1,
      20,
      8,
