...
public class VmServiceWidgetPerfProvider implements WidgetPerfProvider {
  ...
  @Override
  public CompletableFuture<Void> getWidgetTree() {
    // Widget tree inspection requires InspectorService which is not available.
    // Use DevTools for widget tree features.
