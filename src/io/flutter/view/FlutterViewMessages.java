...
// TODO: change to an event to collect the fields
...
public class FlutterViewMessages {
  ...
  public interface FlutterDebugNotifier {
    void debugActive(ObservatoryConnector observatoryConnector, VmServiceWrapper vmServiceWrapper, VmService vmService);
  }

  public static void sendDebugActive(@NotNull ObservatoryConnector observatoryConnector, @NotNull VmServiceWrapper vmServiceWrapper, @NotNull VmService vmService) {
    final MessageBus bus = ApplicationManager.getApplication().getMessageBus();
    final FlutterDebugNotifier publisher = bus.syncPublisher(FLUTTER_DEBUG_TOPIC);
    publisher.debugActive(observatoryConnector, vmServiceWrapper, vmService);
  }
}
