...
public class DisplayRefreshRateManager {
  ...
  public Double getCurrentDisplayRefreshRateRaw() {
    return displayRefreshRateStream.getValue();
  }
  ...
  public int getTargetMicrosPerFrame() {
    final Double fps = getCurrentDisplayRefreshRateRaw();
    final double effectiveFps = (fps != null && fps > 0) ? fps : defaultRefreshRate;
    return (int)(1000000.0 / effectiveFps);
  }
