...
public class FlutterLogView extends JPanel implements ConsoleView, DataProvider, FlutterLog.Listener {
  ...
  private class ShowTimeStampsAction extends ToggleAction {
    ...
    public boolean isSelected(AnActionEvent e) {
      return flutterLogPreferences.SHOW_TIMESTAMP;
    }

    @Override
    public void setSelected(AnActionEvent e, boolean state) {
      flutterLogPreferences.SHOW_TIMESTAMP = state;
  ...
  private class ShowSequenceNumbersAction extends ToggleAction {
    ...
    @Override
    public boolean isSelected(AnActionEvent e) {
      return flutterLogPreferences.SHOW_SEQUENCE_NUMBERS;
    }

    @Override
    public void setSelected(AnActionEvent e, boolean state) {
      flutterLogPreferences.SHOW_SEQUENCE_NUMBERS = state;
  ...
  private class ShowCategoryAction extends ToggleAction {
    ...
    @Override
    public boolean isSelected(AnActionEvent e) {
      return flutterLogPreferences.SHOW_LOG_CATEGORY;
    }

    @Override
    public void setSelected(AnActionEvent e, boolean state) {
      flutterLogPreferences.SHOW_LOG_CATEGORY = state;
  ...
  private class ShowLevelAction extends ToggleAction {
    ...
    @Override
    public boolean isSelected(AnActionEvent e) {
      return flutterLogPreferences.SHOW_LOG_LEVEL;
    }

    @Override
    public void setSelected(AnActionEvent e, boolean state) {
      flutterLogPreferences.SHOW_LOG_LEVEL = state;
  ...
  private class ShowColorsAction extends ToggleAction {
    ...
    @Override
    public boolean isSelected(AnActionEvent e) {
      return flutterLogPreferences.SHOW_COLOR;
    }

    @Override
    public void setSelected(AnActionEvent e, boolean state) {
      flutterLogPreferences.SHOW_COLOR = state;
