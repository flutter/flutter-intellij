...
elif [ -f "/Applications/IntelliJ IDEA CE.app/Contents/bin/inspect.sh" ]; then
  IDEA_INSPECT_SCRIPT="/Applications/IntelliJ IDEA CE.app/Contents/bin/inspect.sh"
elif [ -f "/Applications/IntelliJ IDEA.app/Contents/bin/inspect.sh" ]; then
  IDEA_INSPECT_SCRIPT="/Applications/IntelliJ IDEA.app/Contents/bin/inspect.sh"
fi
