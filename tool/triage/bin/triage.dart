...
void printCreationTimeCounts(Iterable<Issue> issues,
  ...
  var unprioritizedPercentage =
      '${(unpriortizedCount / issueCount).toStringAsFixed(2).substring(2)}%';
  print('unprioritized: $unpriortizedCount ($unprioritizedPercentage)\n');
