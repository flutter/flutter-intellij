...
public class CpuSamplesEvent extends Element {
  ...
  public Object getFunctions() {
    final JsonElement elem = json.get("functions");
    if (elem == null) return null;

    if (elem.isJsonObject()) {
    final JsonObject o = (JsonObject) elem;
    if (o.get("type").getAsString().equals("@Obj")) return new ObjRef(o);
    if (o.get("type").getAsString().equals("NativeFunction")) return new NativeFunction(o);
    }
    return null;
  }
