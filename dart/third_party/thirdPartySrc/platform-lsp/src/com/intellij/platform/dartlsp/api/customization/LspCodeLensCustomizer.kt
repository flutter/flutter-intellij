...
package com.intellij.platform.dartlsp.api.customization
...
open class LspCodeLensSupport : LspCodeLensCustomizer() {
   ...
   * The utility functions [com.intellij.platform.dartlsp.api.Lsp4jService.extractLocationsFromJson] and
   * [com.intellij.platform.dartlsp.util.navigateOrShowPopup] are provided to handle the most common cases.
   ...
   * @see com.intellij.platform.dartlsp.api.Lsp4jService.extractLocationsFromJson
   * @see com.intellij.platform.dartlsp.util.navigateOrShowPopup
   */
