...
import com.intellij.platform.dartlsp.api.LspServerState.Initializing
...
import com.intellij.platform.dartlsp.impl.connector.Lsp4jServerConnector
import com.intellij.platform.dartlsp.impl.connector.Lsp4jServerConnectorSocket
...
private val logger = logger<LspServerImpl>()
...
class LspServerImpl internal constructor(
   ...
   * @see LspServerImpl.doesServerExplicitlyWantToFormatThisFile
   */
   ...
   * [com.intellij.platform.dartlsp.api.customization.LspFormattingSupport.shouldFormatThisFileExclusivelyByServer]
   */
