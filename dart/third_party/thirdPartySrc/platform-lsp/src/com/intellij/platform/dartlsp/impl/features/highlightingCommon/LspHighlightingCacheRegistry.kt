package com.intellij.platform.dartlsp.impl.features.highlightingCommon
...
import com.intellij.platform.dartlsp.impl.features.codeLens.LspCodeLensCache
import com.intellij.platform.dartlsp.impl.features.folding.LspFoldingRangeCache
import com.intellij.platform.dartlsp.impl.features.highlighting.DiagnosticAndQuickFixes
import com.intellij.platform.dartlsp.impl.features.highlighting.LspDocumentLinkCache
import com.intellij.platform.dartlsp.impl.features.highlighting.LspPublishDiagnosticsCache
import com.intellij.platform.dartlsp.impl.features.highlighting.LspPullDiagnosticsCache
import com.intellij.platform.dartlsp.impl.features.highlighting.LspSemanticTokensCache
import com.intellij.platform.dartlsp.impl.features.highlighting.copyDiagnosticWithRange
import com.intellij.platform.dartlsp.impl.features.inlayHint.LspInlayHintsCache
import com.intellij.platform.dartlsp.impl.features.inlayHintColor.LspDocumentColorCache
import com.intellij.platform.dartlsp.util.getLsp4jRange
...
internal class LspHighlightingCacheRegistry(private val lspServer: LspServerImpl) {
   ...
   * [LspIntentionAction][com.intellij.platform.dartlsp.api.customization.LspIntentionAction] object at this moment,
   * but clients shouldn't care about that. For curious: see [LspQuickFixSet][com.intellij.platform.dartlsp.impl.features.quickFix.LspQuickFixSet].
   */
