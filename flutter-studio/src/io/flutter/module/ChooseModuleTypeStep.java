...
public class ChooseModuleTypeStep extends ModelWizardStep<FlutterModuleModel> {
  ...
  public ChooseModuleTypeStep(@NotNull FlutterModuleModel model) {
    this(model, FlutterDescriptionProvider.getGalleryList(false));
  }

  private ChooseModuleTypeStep(@NotNull FlutterModuleModel model, @NotNull Collection<ModuleGalleryEntry> moduleGalleryEntries) {
  ...
  public Collection<? extends ModelWizardStep> createDependentSteps() {
    ...
    FlutterDescriptionProvider.ModuleModelWrapper wrapper = new FlutterDescriptionProvider.ModuleModelWrapper(getModel());
    for (ModuleGalleryEntry moduleGalleryEntry : myModuleGalleryEntryList) {
      SkippableWizardStep step = moduleGalleryEntry.createStep(wrapper);
      allSteps.add(step);
