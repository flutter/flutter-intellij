...
import com.android.tools.idea.npwOld.cpp.ConfigureCppSupportStep;
import com.android.tools.idea.npwOld.model.NewProjectModel;
import com.android.tools.idea.npwOld.model.NewProjectModuleModel;
import com.android.tools.idea.npwOld.model.RenderTemplateModel;
import com.android.tools.idea.npwOld.template.ConfigureTemplateParametersStep;
...
public class ChooseAndroidProjectStep extends ModelWizardStep<NewProjectModel> {
  ...
  private static ASGallery<TemplateRenderer> createGallery(@NotNull String title, @NotNull FormFactor formFactor) {
    ...
    ASGallery<TemplateRenderer> gallery = new WizardGallery<>(
      title,
      galEntry -> galEntry == null ? null : galEntry.getImage() == null ? null : IconUtil.createImageIcon(galEntry.getImage()),
      galEntry -> galEntry == null ? message("android.wizard.gallery.item.none") : galEntry.getImageLabel());
