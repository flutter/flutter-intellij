...
import com.android.tools.idea.npwOld.template.components.ActivityComboProvider;
import com.android.tools.idea.npwOld.template.components.CheckboxProvider;
import com.android.tools.idea.npwOld.template.components.ComponentProvider;
import com.android.tools.idea.npwOld.template.components.EnumComboProvider;
import com.android.tools.idea.npwOld.template.components.LabelWithEditButtonProvider;
import com.android.tools.idea.npwOld.template.components.LanguageComboProvider;
import com.android.tools.idea.npwOld.template.components.ModuleTemplateComboProvider;
import com.android.tools.idea.npwOld.template.components.PackageComboProvider;
import com.android.tools.idea.npwOld.template.components.ParameterComponentProvider;
import com.android.tools.idea.npwOld.template.components.SeparatorProvider;
import com.android.tools.idea.npwOld.template.components.TextFieldProvider;
    ...
    try {
      ...
      for (Parameter parameter : parameters) {
        ...
        if (!enabledStr.isEmpty()) {
          boolean enabled = false;//myEvaluator.evaluateBooleanExpression(enabledStr, allValues, true);
        ...
        if (!visibilityStr.isEmpty()) {
          boolean visible = false;//myEvaluator.evaluateBooleanExpression(visibilityStr, allValues, true);
