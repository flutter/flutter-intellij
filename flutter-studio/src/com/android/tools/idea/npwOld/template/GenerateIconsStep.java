...
import com.android.tools.idea.npwOld.assetstudio.wizard.GenerateImageAssetPanel;
...
public final class GenerateIconsStep extends ModelWizardStep<RenderTemplateModel> {
  ...
  protected void onEntering() {
    ...
    if (iconNameExpression != null && !iconNameExpression.isEmpty()) {
      ...
      iconName = iconNameExpression;//evaluator.evaluate(iconNameExpression, getModel().getTemplateValues());
    }
