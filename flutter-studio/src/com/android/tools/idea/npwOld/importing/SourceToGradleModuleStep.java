...
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.DOES_NOT_EXIST;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.EMPTY_PATH;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.INTERNAL_ERROR;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.IS_PROJECT_OR_MODULE;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.MISSING_SUBPROJECTS;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.NOT_ADT_OR_GRADLE;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.NO_MODULES_SELECTED;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.OK;
import static com.android.tools.idea.npwOld.importing.SourceToGradleModuleStep.PathValidationResult.ResultType.VALIDATING;
...
import com.android.tools.idea.npwOld.AsyncValidator;
