 ...
 */
package com.android.tools.idea.npwOld.instantapp;

import static com.android.tools.idea.npwOld.model.NewProjectModel.getSuggestedProjectPackage;
...
import com.android.tools.idea.npwOld.module.ConfigureAndroidModuleStep;
...
import com.android.tools.idea.npwOld.module.ModuleTemplateGalleryEntry;
...
public class NewInstantAppModuleDescriptionProvider implements ModuleDescriptionProvider {
  ...
  private static class FeatureTemplateGalleryEntry implements ModuleTemplateGalleryEntry {
    ...
    FeatureTemplateGalleryEntry() {
      String moduleName = message("android.wizard.module.new.dynamic.module");
