...
import static com.android.tools.idea.npwOld.assetstudio.AssetStudioUtils.toLowerCamelCase;
...
import com.android.tools.idea.npwOld.assetstudio.icon.CategoryIconMap;
import com.android.tools.idea.npwOld.assetstudio.icon.IconGeneratorResult;
import com.android.tools.idea.npwOld.assetstudio.ui.ConfigureIconPanel;
import com.android.tools.idea.npwOld.assetstudio.ui.ConfigureIconView;
import com.android.tools.idea.npwOld.assetstudio.ui.ConfigureLauncherIconPanel;
import com.android.tools.idea.npwOld.assetstudio.ui.PreviewIconsPanel;
...
public final class GenerateImageAssetPanel extends JPanel implements Disposable, PersistentStateComponent<PersistentState> {
  ...
  private void initializeListenersAndBindings() {
    ...
    BooleanExpression isAdaptiveIconOutput =
      (BooleanExpression)BooleanExpression.create(() -> myOutputIconType.get() == AndroidIconType.LAUNCHER, myOutputIconType);
